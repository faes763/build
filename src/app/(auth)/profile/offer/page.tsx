      ...
      <div className="py-5 flex flex-col gap-y-5">
        <div className="flex justify-between gap-5 flex-wrap">
            {works[page-1].map((work,index)=>(
                <div key={work.id+index} className="flex gap-x-5 p-6 rounded-3xl shadow-md ring-1 ring-black ring-opacity-5">
                    <Image className="w-48 h-48" width={200} height={200} src={work.image} alt={work.name}/>
