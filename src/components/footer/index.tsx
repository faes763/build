...
export default function Footer() {
    return (
        <footer id="connection" className="relative shadow-t-lg ring-1 ring-black ring-opacity-5">
            <nav className="container flex gap-x-5 items-center justify-between relative py-5 max-lg:flex-col max-lg:gap-y-5 max-lg:justify-center" >
                <Link href="/" className=" text-2xl font-semibold cursor-pointer">©Buildassistent</Link>
                <ul className="flex gap-x-5 max-lg:flex-col items-center text-center max-lg:gap-y-2 max-lg:text-xl">
